...
public class Swagger2 {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select().apis(RequestHandlerSelectors.basePackage("com.zivy009.demo.springbootshirodwz.controller")).paths(PathSelectors.any())
                .build();
    }
